...
final class Version20180222160834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS hydrometers (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, token_id INT DEFAULT NULL, esp_id VARCHAR(255) DEFAULT NULL, name VARCHAR(190) DEFAULT NULL, metric_temperature VARCHAR(190) DEFAULT NULL, metric_gravity VARCHAR(190) DEFAULT NULL, changed DATETIME DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_8234F3C1A76ED395 (user_id), UNIQUE INDEX UNIQ_8234F3C141DEE7B9 (token_id), UNIQUE INDEX id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(190) NOT NULL, username VARCHAR(190) NOT NULL, api_token VARCHAR(64) DEFAULT NULL, time_zone VARCHAR(255) DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, changed DATETIME DEFAULT NULL, deleted DATETIME DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, UNIQUE INDEX email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
